...
const LoginForm = ({ className, ...props }: React.ComponentProps<"div">) => {
  const { isLoggedIn, setIsLoggedIn, nickname, profileImage } = useUserStore();
          ...
          {isLoggedIn ? (
            <div>
              <p className="text-center mt-6">
                <span className="font-bold">{nickname}</span>님 안녕하세요.
                오늘도 좋은 하루 되세요.
              </p>
              <p className="text-sm text-center text-gray-400">
                로그아웃을 하면 accessToken, refreshToken 쿠키가 삭제됩니다.
              </p>
              <img
                className="w-24 mx-auto my-5 rounded-full"
                src={profileImage}
              />
